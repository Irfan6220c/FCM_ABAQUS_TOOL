...
your_mesh = mesh.Mesh.from_file('Plate_with_potato.stl')
a =  your_mesh.vectors
...
#your_mesh = mesh.Mesh.from_file('geometries/Geo_1.stl')

#your_mesh = mesh.Mesh.from_file('geometries/Geo_1_rhino.stl')
