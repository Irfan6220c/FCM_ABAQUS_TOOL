# -*- coding: utf-8 -*-
"""
Created on Mon Oct 29 22:13:31 2018
...
#%%
def getGaussCoordinates (Integ_Input_list, Elem_num):    

    pyplot.figure()             # Create new figure for every cut element
    ...
    """
    Uncomment the follwoing line to visualize the inegration point is Xi-Eta coordinates for each leaf
    """
#            if a==1:     
